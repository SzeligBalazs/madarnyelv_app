...
import 'package:madarnyelv_fordito/main.dart';
...
class MadarR extends StatefulWidget {
  const MadarR({Key? key}) : super(key: key);

  @override
  _MadarRState createState() => _MadarRState();
}

class _MadarRState extends State<MadarR> {
